    ...
    <main className="space-y-4 px-4 pb-12 pt-6">
      ...
      <Section icon="📋" title="What we collect, and why">
        ...
        <p>
          ...
          odometer) are sent to Google&apos;s Gemini model to generate an answer grounded in your own data — that data
          isn&apos;t used to train any model or shared beyond answering your question.
        </p>
      </Section>
      ...
      <Section icon="🗑️" title="Deleting your data">
        ...
        <p>
          ...
          account is kept on hold in case you change your mind — reach out and support can reactivate it. After 60
          days, it&apos;s permanently and irreversibly deleted, along with every car, service record, and expense on it.
        </p>
      </Section>

      <Section icon="✉️" title="Questions?">
        <p>
          If anything here is unclear or you want your data handled differently, reach out — we&apos;re happy to talk
          it through.
        </p>
      </Section>
